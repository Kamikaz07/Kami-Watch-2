          ...
          <div class="col-md-3">
            ...
            <div class="card-header">
              ...
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $lin['NomeUti'];?></h3>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="Password" class="form-control" id="PasswdUti1" placeholder="Password Antiga" name="PasswdUti1" onkeyup="return validaCPass2();">
                        </div>
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="Password" class="form-control" id="PasswdUti" placeholder="Password Atual" name="PasswdUti"    onkeyup="return validaCPass2();" onkeyup="return validaPass(this);" onblur="return validaCPass();">
                        </div>
                        <span class="msg-pass"></span>
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="Password" class="form-control" id="PasswdUti2" placeholder="Confirmar Password" name="PasswdUti2" onkeyup="return validaCPass();">
                        </div>
                        <span class="msg-cpass"></span>
                  </div>
                  ...
                  <form class="form-horizontal" method="POST" action="index.php?cmd=upd-uti&cod=<?php echo $c;?>">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" id="inputEmail" placeholder="Email" name="LoginUti" value="<?php echo $lin['LoginUti'];?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-3 col-form-label">Nome</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName2" placeholder="Nome" name="NomeUti" value="<?php echo $lin['NomeUti'];?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputExperience" class="col-sm-3 col-form-label">Observações</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputExperience" placeholder="Observações" name="Observa_esUti" value="<?php echo $lin['Observa_esUti'];?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputSkills" class="col-sm-3 col-form-label">Data de Nascimento</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" placeholder="dd/mm/yyyy" data-mask name="DatanascUti" value="<?php echo $lin['DatanascUti'];?>" disabled>
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
