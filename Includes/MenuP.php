...
<?php
$c=$_SESSION['codi'];
$h=$sql="select * from DadosBiometricos DB,Paciente P where DB.NumPaci=P.NumPaci and NumPaci = $c";

if ($pesquisa !='')
		$sql.=" and ((NomePaci like '$pesquisa') or (FreqCard like '$pesquisa') or (OxigSang like '$pesquisa') or (Tempera like '$pesquisa') or (DataDB like '$pesquisa'))";
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="#" class="dropdown-item" data-toggle="modal" data-target="#modal-default">Familia</a></li>
 ...
 <div class="form-inline">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
          ...
          <li class="nav-item">
            <a href="index.php?cmd=DashboardU" class="nav-link">
          ...
          <li class="nav-item">
            <a href="index.php?cmd=familia" class="nav-link">
...
<?php
    $c=$_SESSION['codi'];
	$s="select * from DadosBiometricos DB, Paciente P, ParametosMedicos PM where DB.NumPaci=P.NumPaci and PM.NumPaci=P.NumPaci and DB.NumPaci = $c";
	$res=$lig->query($s);
        ...
        <div class="modal-body">
              ...
              <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                  ...
                  <form action="index.php?cmd=login_paci" method="POST">

                    <div class="input-group mb-3">
                      <input type="email" class="form-control" placeholder="Email" name = "LoginFami">
                      <div class="input-group-append">
                    ...
                    <div class="input-group mb-3">
                      <input type="password" class="form-control" placeholder="Password" name = "PasswdFami">
                      <div class="input-group-append">
                        <div class="input-group-text">
  ...
  <div class="modal fade" id="modal-alerta">
        <div class="modal-dialog modal-lg">
          <div class="modal-content bg-danger">
            ...
            <?php 
            $c=$_SESSION['codi'];
            $s="select * from DadosBiometricos DB, Paciente P, ParametosMedicos PM where DB.NumPaci=P.NumPaci and PM.NumPaci=P.NumPaci and DB.NumPaci = $c order by DB.DataDB desc ";
            $res=$lig->query($s);
            $lin=$res->fetch_array();
