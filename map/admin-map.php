...
<script>
    ...
    function initMap() {
        var portugal = {lat: 38.763535, lng: -9.408780};
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyBSQfLJz3H-FJKNPyMHkdPQeD29k8IVu4A&callback=initMap">
</script>